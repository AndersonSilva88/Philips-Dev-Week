package com.anderson.devweekapplication.entity;

import javax.persistence.*;

@Entity
public class OcorenciaExame {
    @Id
    ...
    public OcorenciaExame(){
    }

    public OcorenciaExame(Integer regiaoid, Integer mes, Long faixaid, Integer qntexames){
